...
while True:       
    ...
    school_text=score_font.render("B.S.PATEL PRIMARY SCHOOL", False, (255,25,0))  
    name_text=score_font.render("DHRUVI GAJERA", False, (255,25,0))  
    grade_text=score_font.render("12TH", False, (255,25,0))  
